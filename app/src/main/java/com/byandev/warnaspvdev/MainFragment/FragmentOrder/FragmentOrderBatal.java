...
public class FragmentOrderBatal extends Fragment {
  ...
  private ImageView ic_kosong;
    ...
    public FragmentOrderBatal(){

    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle save) {
//        View view = inflater.inflate(R.layout.fragment_order_batal, container, false);
    ...
    private void firstLoad(){
        ...
        mApiService.orderByStatus(sharedPrefManager.getSpBranchId(), sharedPrefManager.getSpOutletId(),3, limit, 0).enqueue(new Callback<RespOrderStatus>() {
            @Override
    ...
    private void loadMore() {
        itShouldLoadMore = false;
        mApiService.orderByStatus(sharedPrefManager.getSpBranchId(), sharedPrefManager.getSpOutletId(),3, limit, offset).enqueue(new Callback<RespOrderStatus>() {
            @Override
            public void onResponse(Call<RespOrderStatus> call, Response<RespOrderStatus> response) {
                if (response.isSuccessful()) {
                    if (response.body() != null && response.body().getApiStatus() == 1) {
